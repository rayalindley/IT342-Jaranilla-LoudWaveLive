  ...
  return (
    <MainLayout>
      <div className="partner-page">
        <p className="eyebrow">Organizer network</p>
        <h1>Partner With LoudWave Live</h1>
        <p>
          Bring concerts, venue nights, and festival-scale moments to a larger audience through a premium ticketing platform.
        </p>
        ...
        {!user ? (
          <div className="partner-login-prompt">
            <p>Please log in first before submitting a partnership application.</p>
            <Link to="/login">
